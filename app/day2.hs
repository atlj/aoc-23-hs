...
testParseCubeSet =
  TestCase $ do
    assertEqual "parses red cubeset" (parseCubeSet "1 red") Cubeset {red = 1, green = 0, blue = 0}
    assertEqual "parses multiple cubes in cubeset" (parseCubeSet "1 red, 888 green, 0 blue") Cubeset {red = 1, green = 888, blue = 0}
...
main :: IO ()
main = do
  result <- runTestTT $ TestList [testParseCubeSet]
  defaultMain
